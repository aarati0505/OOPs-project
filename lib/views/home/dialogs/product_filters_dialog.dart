              ...
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  label: Text(_useCurrentLocation 
                      ? (_selectedAddress ?? 'Location loaded') 
...
class _DistanceFilter extends StatefulWidget {
  const _DistanceFilter();

  @override
  State<_DistanceFilter> createState() => _DistanceFilterState();
}

class _DistanceFilterState extends State<_DistanceFilter> {
  double _maxDistance = 10; // in km
